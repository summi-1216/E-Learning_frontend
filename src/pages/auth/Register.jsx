...
const Register = () => {
  ...
  const submitHandler = async (e) => {
    ...
    await registerUser(name, email, role, password, navigate);
  };
        ...
        <div class="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full">
          <div class="border border-gray-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form class="space-y-4" onSubmit={submitHandler}>
              <div class="mb-8">
                <h3 class="text-[#9625af] text-2xl font-bold">Sign In</h3>
              ...
              <div class="!mt-8">
                ...
                >
                  {btnLoading ? "Please Wait..." : "SignIn Here"}
                </button>
              </div>
              ...
              <p class="text-sm !mt-8 text-center text-gray-800">
                ...
                class="text-[#9625af] font-semibold hover:underline ml-1 whitespace-nowrap"
              >
