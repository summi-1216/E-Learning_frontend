...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-5 shadow ">
    <div className="container mx-auto px-4">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="mb-4 md:mb-0">
        <h3 className=" text-xl font-bold">
            Skill<span className="text-[#751f88]">wave</span>
          </h3>
          <p className="text-xs">© 2024 Your E-Learning Program. All rights reserved.</p>
        </div>
        
        <div className="flex space-x-4 mt-4 md:mt-0">
          <a href="https://facebook.com" className="hover:text-[#9625af]" aria-label="Facebook">
          ...
          <a href="https://twitter.com" className="hover:text-[#9625af]" aria-label="Twitter">
          ...
          <a href="https://linkedin.com" className="hover:text-[#9625af]" aria-label="LinkedIn">
